...
spark-submit --packages com.amazonaws:aws-java-sdk:1.7.4,org.apache.hadoop:hadoop-aws:2.7.7 --driver-class-path /usr/local/spark/jars/postgresql-42.2.14.jar --jars /usr/local/spark/jars/postgresql-42.2.14.jar --master spark://ec2-54-202-214-49.us-west-2.compute.amazonaws.com:7077 src/batch_process_gps.py s3a://gps-data-processed/gps_stream_total_activities_010_dt_11.csv s3a://gps-data-processed/gps_batch_total_activities_010_dt_11.csv update
spark-submit --packages com.amazonaws:aws-java-sdk:1.7.4,org.apache.hadoop:hadoop-aws:2.7.7 --driver-class-path /usr/local/spark/jars/postgresql-42.2.14.jar --jars /usr/local/spark/jars/postgresql-42.2.14.jar --master spark://ec2-54-202-214-49.us-west-2.compute.amazonaws.com:7077 src/batch_process_gps.py s3a://gps-data-processed/gps_stream_total_activities_010_dt_12.csv s3a://gps-data-processed/gps_batch_total_activities_010_dt_12.csv update
spark-submit --packages com.amazonaws:aws-java-sdk:1.7.4,org.apache.hadoop:hadoop-aws:2.7.7 --driver-class-path /usr/local/spark/jars/postgresql-42.2.14.jar --jars /usr/local/spark/jars/postgresql-42.2.14.jar --master spark://ec2-54-202-214-49.us-west-2.compute.amazonaws.com:7077 src/batch_process_gps.py s3a://gps-data-processed/gps_stream_total_activities_010_dt_13.csv s3a://gps-data-processed/gps_batch_total_activities_010_dt_13.csv update
spark-submit --packages com.amazonaws:aws-java-sdk:1.7.4,org.apache.hadoop:hadoop-aws:2.7.7 --driver-class-path /usr/local/spark/jars/postgresql-42.2.14.jar --jars /usr/local/spark/jars/postgresql-42.2.14.jar --master spark://ec2-54-202-214-49.us-west-2.compute.amazonaws.com:7077 src/batch_process_gps.py s3a://gps-data-processed/gps_stream_total_activities_010_dt_14.csv s3a://gps-data-processed/gps_batch_total_activities_010_dt_14.csv update
spark-submit --packages com.amazonaws:aws-java-sdk:1.7.4,org.apache.hadoop:hadoop-aws:2.7.7 --driver-class-path /usr/local/spark/jars/postgresql-42.2.14.jar --jars /usr/local/spark/jars/postgresql-42.2.14.jar --master spark://ec2-54-202-214-49.us-west-2.compute.amazonaws.com:7077 src/batch_process_gps.py s3a://gps-data-processed/gps_stream_total_activities_010_dt_15.csv s3a://gps-data-processed/gps_batch_total_activities_010_dt_15.csv update
spark-submit --packages com.amazonaws:aws-java-sdk:1.7.4,org.apache.hadoop:hadoop-aws:2.7.7 --driver-class-path /usr/local/spark/jars/postgresql-42.2.14.jar --jars /usr/local/spark/jars/postgresql-42.2.14.jar --master spark://ec2-54-202-214-49.us-west-2.compute.amazonaws.com:7077 src/batch_process_gps.py s3a://gps-data-processed/gps_stream_total_activities_010_dt_16.csv s3a://gps-data-processed/gps_batch_total_activities_010_dt_16.csv update
spark-submit --packages com.amazonaws:aws-java-sdk:1.7.4,org.apache.hadoop:hadoop-aws:2.7.7 --driver-class-path /usr/local/spark/jars/postgresql-42.2.14.jar --jars /usr/local/spark/jars/postgresql-42.2.14.jar --master spark://ec2-54-202-214-49.us-west-2.compute.amazonaws.com:7077 src/batch_process_gps.py s3a://gps-data-processed/gps_stream_total_activities_010_dt_17.csv s3a://gps-data-processed/gps_batch_total_activities_010_dt_17.csv update
