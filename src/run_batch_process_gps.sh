...
file 0 -> start 
all other files -> update 


# seem to work 
spark-submit --packages com.amazonaws:aws-java-sdk:1.7.4,org.apache.hadoop:hadoop-aws:2.7.7 --driver-class-path postgresql-42.2.14.jar --jars postgresql-42.2.14.jar --master local src/batch_process_gps.py data/gps_stream_total_activities_001_dt_00.csv data/gps_batch_total_activities_001_dt_00.csv start
...
# hardcode full path - try to avoid
